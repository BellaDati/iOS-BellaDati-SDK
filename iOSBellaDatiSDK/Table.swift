...
public class Table:View {
    ...
    public func downloadOnLineTable(filter:String? = nil,completion:((_ error:NSError?) -> ())? = nil) {
        ...
        let getData =
            ...
            {
                APIClient.sharedInstance.getData(service: APIClient.APIService.VIEWS, id: String(self.viewId!), urlSuffix: ["table","json"],params:paramsarray){(getData,getError) in
